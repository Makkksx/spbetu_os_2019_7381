...
DATA		SEGMENT
	...
	finish_message db 0dh, 0ah, 'Program finished with code #$'				;сообщение о завершении программы
...
CODE	SEGMENT
	...
	file_path   db 30 dup(0)   ;место под путь до файла (оставляем место с запасом)
