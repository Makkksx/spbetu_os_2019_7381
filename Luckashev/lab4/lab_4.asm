...
DATA segment
	load_msg db 'Loading resident', 13, 10, '$'
	already_loaded_msg db 'Resident has been loaded already', 13, 10, '$'
	unload_msg db 'Unloading resident', 13, 10, '$'
DATA ends

CODE segment
	assume cs:CODE, ds:DATA, es:DATA, ss:MY_STACK

;input dx - line; column
setCurs     proc 
	push    ax
	push    bx		
	push    cx	
...
ROUT    proc    far 
	...
	KEEP_AX     dw 0	
	KEEP_SP     dw 0
	COUNT       db 'Interruption count: 0000 $' 
